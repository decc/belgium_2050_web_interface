class CostsSensitivity
  ...
  comparatorLIs = for code in twentyfifty.comparator_pathways
    "<li><a href='#' onclick='twentyfifty.switchComparator(\"#{code}\");$(\"ul#view_comparatorchoice\").toggle(); return false;'>#{twentyfifty.pathwayName(code,code)}</a></li>"
